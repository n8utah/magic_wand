...
constexpr int kSpellScanTopDeviceCount = 5;
constexpr unsigned long kSpellTargetCacheTimeoutMs = 3000;
// Non-blocking scan window; restarts automatically via completion callback.
constexpr uint32_t kSpellBackgroundScanPeriodSec = 3;
// Future: ignore cached targets weaker than this (e.g. -70).
// constexpr int kSpellActivationMinRssiDbm = -70;
